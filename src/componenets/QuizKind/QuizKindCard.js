...
const QuizKindCardContainer = styled(motion.div)`
  display: flex;
...
const QuizKindCard = ({ icon, title, isFemale, onClick, compact = false }) => {
  return (
    <QuizKindCardContainer
