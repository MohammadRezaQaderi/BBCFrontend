...
const AddHeadConsultantForm = ({ data, setReload }) => {
  ...
  const insert_head_consultant = async () => {
    try {
      const response = await axios.post(
        "https://student.baazmoon.com/bbc_api/insert_request",
        {
          table: "users",
          method_type: "insert_head_consultant",
          data: {
  ...
  return (
    <div>
      ...
      <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm">
        <DialogTitle sx={{ textAlign: "center" }}>افزودن سرمشاور</DialogTitle>
        <Grid item xs={12}>
          <hr
            style={{
...
export default AddHeadConsultantForm;
