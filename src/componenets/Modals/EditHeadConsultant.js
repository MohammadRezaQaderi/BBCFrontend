...
const EditHeadConsultantForm = ({ type, data, setReload }) => {
  ...
  const update_head_consultant = async () => {
    try {
      const response = await axios.post(
        "https://student.baazmoon.com/bbc_api/update_request",
        {
          table: "users",
          method_type: "update_head_consultant",
          data: {
...
export default EditHeadConsultantForm;
